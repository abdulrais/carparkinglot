...
public class CarInputCommands {
    public static ArrayList<Car> carsParkingInfo=new ArrayList<Car>();
    public static ArrayList<String> freeSlot=new ArrayList<>();
    ...
    public static ArrayList<String> inputCommands(ArrayList<String> parkingCommands){
        ...
        for(String parking: parkingCommands){
            ...
            if(line2.equals(commands[0])){
                ...
                output.add("There is no such Command");
            }
        }
        return output;
    }  
    
    /* Method For Input Commands*/
    public static String inputCommands(String parkingCommands, int slot){
        ParkingOperations operations=new ParkingOperations();
        ...
        String[] commands=parkingCommands.split(" ");
        if(line2.equals(commands[0])){
            String parkingLot=operations.parkingLotCreation(commands[1]);
            slot+=Integer.parseInt(commands[1]);
            return parkingLot;
